...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    dailyVolume = "2,847,391",
    dailyVolumeLabel = "AUTOMATED MEETINGS CONDUCTED",
    headline = "The AI Engineering Manager for Modern Teams",
    subheadline = "MorphAI runs engineering standups, extracts tasks, tracks blockers, and automates workflows—letting your team focus on building instead of status updates.",
    description = "Trusted by fast-growing engineering teams and enterprises, MorphAI powers autonomous project management across 500+ organizations — with enterprise-grade security, GitHub integration, and real-time progress tracking.",
